...
class Result(BaseResult):
    ...
    def report(self):
        ...
        if self.review:
            ...
            two = ("""<a href="{url}" class="add-another" id="add_id_review" onclick="return "
                    "showAddAnotherPopup(this);"> {label}</a>""").format(url=url_review, label=label)
        one = ("""<a href="{url}" class="add-another" id="add_id_report" onclick="return "
